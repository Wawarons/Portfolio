...
const Projets = () => {
    ...
    const projetsDescription = () => {
        projetsListe.forEach((element, index) => {
            /* title, url, description, langages, nombre, ProjetImg */
        Projets.push(<ProjetsCard key = {index} title = {element.title} url = {element.url} description = {element.description} langages = {element.langages} githubLink={element.githubLink} number =  {element.number} ProjetImg = {element.ProjetImg}></ProjetsCard>)
